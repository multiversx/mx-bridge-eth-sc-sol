...
//
// Solidity: event ERC20SCDeposit(uint112 depositNonce, uint112 batchId, string callData)
func (_ERC20Safe *ERC20SafeFilterer) FilterERC20SCDeposit(opts *bind.FilterOpts) (*ERC20SafeERC20SCDepositIterator, error) {

	logs, sub, err := _ERC20Safe.contract.FilterLogs(opts, "ERC20SCDeposit")
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event ERC20SCDeposit(uint112 depositNonce, uint112 batchId, string callData)
func (_ERC20Safe *ERC20SafeFilterer) WatchERC20SCDeposit(opts *bind.WatchOpts, sink chan<- *ERC20SafeERC20SCDeposit) (event.Subscription, error) {

	logs, sub, err := _ERC20Safe.contract.WatchLogs(opts, "ERC20SCDeposit")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
