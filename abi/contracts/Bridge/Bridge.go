...
//
// Solidity: function getStatusesAfterExecution(uint256 batchNonceElrondETH) view returns(uint8[], bool)
func (_Bridge *BridgeCaller) GetStatusesAfterExecution(opts *bind.CallOpts, batchNonceElrondETH *big.Int) ([]uint8, bool, error) {
	var out []interface{}
...
//
// Solidity: function getStatusesAfterExecution(uint256 batchNonceElrondETH) view returns(uint8[], bool)
func (_Bridge *BridgeSession) GetStatusesAfterExecution(batchNonceElrondETH *big.Int) ([]uint8, bool, error) {
...
//
// Solidity: function getStatusesAfterExecution(uint256 batchNonceElrondETH) view returns(uint8[], bool)
func (_Bridge *BridgeCallerSession) GetStatusesAfterExecution(batchNonceElrondETH *big.Int) ([]uint8, bool, error) {
	return _Bridge.Contract.GetStatusesAfterExecution(&_Bridge.CallOpts, batchNonceElrondETH)
}
