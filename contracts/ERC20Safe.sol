 ...
 */
contract ERC20Safe is Initializable, OwnableUpgradeable, BridgeRole, Pausable {
    ...
    function initialize(address initialOwner) public override(Pausable) initializer {
        batchSize = 10;
        batchBlockLimit = 40;
        batchSettleLimit = 40;
        maxBatchSize = 100;
